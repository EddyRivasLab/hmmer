  ...
  if (hfp->parser == NULL)
    {
      ...
      else ESL_XFAIL(eslEFORMAT, errbuf, "Format tag is '%s': unrecognized.\nCurrent H3 format is 'HMMER3/b'. Previous H2/H3 formats also supported.", tok);
    }
