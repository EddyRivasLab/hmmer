...
static ESL_OPTIONS server_Client_Options[] = {
  ...
  { "--db_ranges",  eslARG_STRING,       NULL, NULL,           NULL, NULL,  NULL,      NULL,   "range(s) of sequences in database to search",                 42 },
  { "--jack",       eslARG_INT,          NULL, NULL,          "n>1", NULL,  NULL,      NULL,   "number of rounds of jackhmmer search to perform",             42 },
  { "--contents",   eslARG_NONE,        FALSE, NULL,           NULL, NULL,  NULL,"--shutdown", "query server about the contents of its databases",            42 },
  ...
  { "--pfamtblout", eslARG_OUTFILE,      NULL, NULL,           NULL, NULL,  NULL,      NULL,   "save pfam-style table of hits/domains to file <f>",            2 },
  { "--chkhmm",     eslARG_OUTFILE,      NULL, NULL,           NULL, NULL,"--jack",    NULL,   "save HMM checkpoints to files <f>-<iteration>.hmm",            2 },
  { "--chkali",     eslARG_OUTFILE,      NULL, NULL,           NULL, NULL,"--jack",    NULL,   "save MSA checkpoints to files <f>-<iteration>.sto",            2 },
  { "--acc",        eslARG_NONE,        FALSE, NULL,           NULL, NULL,  NULL,      NULL,   "prefer accessions over names in output",                       2 },
  { "--noali",      eslARG_NONE,        FALSE, NULL,           NULL, NULL,  NULL,      NULL,   "don't output alignments, so output is smaller",                2 },
  { "--notextw",    eslARG_NONE,         NULL, NULL,           NULL, NULL,  NULL,  "--textw",  "unlimit ASCII text output line width",                         2 },
  { "--textw",      eslARG_INT,         "120", NULL,       "n>=120", NULL,  NULL,"--notextw",  "set max width of ASCII text output lines",                     2 },
  /* Specification of query type */
  { "--qseq",       eslARG_NONE,        FALSE, NULL,           NULL, NULL,  NULL,  "--qmsa",   "query file is single query seq(s), not a profile HMM",         2 },     
  { "--qmsa",       eslARG_NONE,        FALSE, NULL,           NULL, NULL,  NULL,  "--qseq",   "query file contains MSA(s), not profile HMMs",                 2 },     
  { "--qformat",    eslARG_STRING,       NULL, NULL,           NULL, NULL,  NULL,      NULL,   "w/ --qseq|--qmsa: assert query file is in format <s>",         2 },     
  /* Control of scoring system */
  { "--popen",      eslARG_REAL,       "0.02", NULL,     "0<=x<0.5", NULL,  NULL,      NULL,   "gap open probability",                                         3 },
  { "--pextend",    eslARG_REAL,        "0.4", NULL,       "0<=x<1", NULL,  NULL,      NULL,   "gap extend probability",                                       3 },
  { "--mx",         eslARG_STRING, "BLOSUM62", NULL,           NULL, NULL,  NULL,"--mxfile",   "built-in substitution score matrix choice",                    3 },
  { "--mxfile",     eslARG_INFILE,       NULL, NULL,           NULL, NULL,  NULL,    "--mx",   "read subst score matrix from file <f> (on server)",            3 },
  /* Control of reporting thresholds */
  { "-E",           eslARG_REAL,       "10.0", NULL,          "x>0", NULL,  NULL,  REPOPTS,    "report sequences <= this E-value in output",                   4 },
  { "-T",           eslARG_REAL,        FALSE, NULL,           NULL, NULL,  NULL,  REPOPTS,    "report sequences >= this score in output",                     4 },
  { "--domE",       eslARG_REAL,       "10.0", NULL,          "x>0", NULL,  NULL,  DOMREPOPTS, "report domains <= this E-value in output",                     4 },
  { "--domT",       eslARG_REAL,        FALSE, NULL,           NULL, NULL,  NULL,  DOMREPOPTS, "report domains >= this score in output",                       4 },
  /* Control of inclusion (significance) thresholds */
  { "--incE",       eslARG_REAL,       "0.01", NULL,          "x>0", NULL,  NULL,  INCOPTS,    "consider sequences <= this E-value as significant",            5 },
  { "--incT",       eslARG_REAL,        FALSE, NULL,           NULL, NULL,  NULL,  INCOPTS,    "consider sequences >= this score as significant",              5 },
  { "--incdomE",    eslARG_REAL,       "0.01", NULL,          "x>0", NULL,  NULL,  INCDOMOPTS, "consider domains <= this E-value as significant",              5 },
  { "--incdomT",    eslARG_REAL,        FALSE, NULL,           NULL, NULL,  NULL,  INCDOMOPTS, "consider domains >= this score as significant",                5 },
  /* Model-specific thresholding for both reporting and inclusion */
  { "--cut_ga",     eslARG_NONE,        FALSE, NULL,           NULL, NULL,  NULL,  THRESHOPTS, "use profile's GA gathering cutoffs for all thresholds",        6 },
  { "--cut_nc",     eslARG_NONE,        FALSE, NULL,           NULL, NULL,  NULL,  THRESHOPTS, "use profile's NC noise cutoffs for all thresholds",            6 },
  { "--cut_tc",     eslARG_NONE,        FALSE, NULL,           NULL, NULL,  NULL,  THRESHOPTS, "use profile's TC trusted cutoffs for all thresholds",          6 },
  ...
  { "--eentexp",    eslARG_NONE,     "default",NULL,           NULL,EFFOPTS,"--jack",  NULL,   "adjust eff seq # to reach rel. ent. using exp scaling",       10 },
  ...
  { "--ere",        eslARG_REAL,         NULL, NULL,          "x>0",   NULL,"--jack",  NULL,   "for --eent[exp]: set minimum rel entropy/pos to <x>",         10 },
...
/* Other options */
  ...
  { "--fast",       eslARG_NONE,       FALSE, NULL,            NULL,CONOPTS,   NULL,   NULL,   "assign cols w/ >= symfrac residues as consensus",             99 }, // this option is disallowed, but p7_builder crashes if it is not defined
