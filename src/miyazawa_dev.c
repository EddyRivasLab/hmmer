...
/* Control of scoring system */
  ...
  /* --lambda (base of the scoring system) */
...
main(int argc, char **argv)
{
  ...
  /* Initializations */
  p7_FLogsumInit();		/* we're going to use table-driven Logsum() approximations at times */   /* I DO NOT THINK THIS IS NEEDED */
...
serial_master(ESL_GETOPTS *go, struct cfg_s *cfg)
{
  ...
  while ((qstatus = esl_sqio_Read(qfp, qsq)) == eslOK)
    {
      P7_OPROFILE     *om       = NULL;           /* optimized query profile   */              /* DON'T NEED THIS! */
