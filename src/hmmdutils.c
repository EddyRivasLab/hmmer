...
static ESL_OPTIONS searchOpts[] = {
  ...
  { "--vertcodon",  eslARG_NONE,        FALSE, NULL, NULL,      NULL,  NULL, NULL,        "show the DNA codon vertically in domain alignment",            2 }, /*for hmmscant */
  ...
  //{ "--hmmsearcht",    eslARG_NONE,        NULL,  NULL, NULL,    NULL,  NULL,  "--hmmdb",       "search sequence database with a 6 frame translated DNA sequence",  12 },
