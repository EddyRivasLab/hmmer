...
P7Viterbi(char *dsq, int L, struct plan7_s *hmm, struct dpmatrix_s *mx, struct p7trace_s **ret_tr)
{
  ...
  /* Make sure we have room in the DP matrix for 0..L rows, 0..M-1 columns.
   */ 
 ...
 * Eric Lindahl, Stanford University, 2002.
 * 
 ...
 */
struct dpmatrix_s *
CreatePlan7Matrix(int N, int M, int padN, padM)
{
  int i,n;
