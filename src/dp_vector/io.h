...
extern int p7_oprofile_Write_neon64(FILE *ffp, FILE *pfp, P7_OPROFILE *om);
...
extern int p7_oprofile_ReadMSV_neon64 (P7_HMMFILE *hfp, ESL_ALPHABET **byp_abc, P7_OPROFILE **ret_om);
...
extern int p7_oprofile_ReadInfoMSV_neon64(P7_HMMFILE *hfp, ESL_ALPHABET **byp_abc, P7_OPROFILE **ret_om);
...
extern int p7_oprofile_ReadRest_neon64(P7_HMMFILE *hfp, P7_OPROFILE *om);
