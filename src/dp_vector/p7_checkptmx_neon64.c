 ...
 */
P7_CHECKPTMX *
p7_checkptmx_Create_neon64(int M, int L, int64_t ramlimit)
{
#ifdef HAVE_NEON
 ...
 */
int
p7_checkptmx_GrowTo_neon64(P7_CHECKPTMX *ox, int M, int L)
{
 #ifdef HAVE_NEON 
 ...
 */
size_t
p7_checkptmx_Sizeof_neon64(const P7_CHECKPTMX *ox)
{
 ...
 */
size_t
p7_checkptmx_MinSizeof_neon64(int M, int L)
{ 
  size_t n    = sizeof(P7_CHECKPTMX);
 ...
 */
int
p7_checkptmx_Reuse_neon64(P7_CHECKPTMX *ox)
{
#ifdef p7_DEBUGGING
  int status;
#endif
 ...
 */
void
p7_checkptmx_Destroy_neon64(P7_CHECKPTMX *ox)
{
 if (ox) {
#ifdef HAVE_NEON  
 ...
 */
int
p7_checkptmx_DumpFBRow_neon64(P7_CHECKPTMX *ox, int rowi, esl_neon_128f_t *dpc, char *pfx)
{
#ifdef HAVE_NEON
