...
extern int p7_SSVFilter_neon    (const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, float *ret_sc); //SSE-only version
extern int p7_SSVFilter_neon64    (const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, float *ret_sc); //SSE-only version
