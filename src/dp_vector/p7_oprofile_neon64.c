 ...
 */
P7_OPROFILE *
p7_oprofile_Create_neon64(int allocM, const ESL_ALPHABET *abc)
{
#ifdef HAVE_NEON64
  P7_OPROFILE *om  = NULL;
 ...
 */
void
p7_oprofile_Destroy_neon64(P7_OPROFILE *om)
{
#ifdef HAVE_NEON64
  if (om == NULL) return;
 ...
 */
size_t
p7_oprofile_Sizeof_neon64(const P7_OPROFILE *om)
{
  size_t n   = 0;
#ifdef HAVE_NEON64
 ...
 */
P7_OPROFILE *
p7_oprofile_Clone_neon64(const P7_OPROFILE *om1)
{
#ifdef HAVE_NEON64
 ...
 */
int
sf_conversion_neon64(P7_OPROFILE *om)
{
#ifdef HAVE_NEON64
 ...
 */
int
mf_conversion_neon64(const P7_PROFILE *gm, P7_OPROFILE *om)
{
#ifdef HAVE_NEON64
 ...
 */
int
vf_conversion_neon64(const P7_PROFILE *gm, P7_OPROFILE *om)
{
#ifdef HAVE_NEON64
  int     M   = gm->M;		/* length of the query                                          */
 ...
 */
int
fb_conversion_neon64(const P7_PROFILE *gm, P7_OPROFILE *om)
{
#ifdef HAVE_NEON64
  int     M   = gm->M;		/* length of the query                                          */
 ...
 */
int
p7_oprofile_Convert_neon64(const P7_PROFILE *gm, P7_OPROFILE *om)
{
#ifdef HAVE_NEON64
  int status, z;
 ...
 */
int
p7_oprofile_GetFwdTransitionArray_neon64(const P7_OPROFILE *om, int type, float *arr )
{
#ifdef HAVE_NEON64
 ...
 */
int
p7_oprofile_GetMSVEmissionScoreArray_neon64(const P7_OPROFILE *om, uint8_t *arr )
{
#ifdef HAVE_NEON64
  int x, q, z, k;
 ...
 */
int
p7_oprofile_GetFwdEmissionScoreArray_neon64(const P7_OPROFILE *om, float *arr )
{
#ifdef HAVE_NEON64
  int x, q, z, k;
 ...
 */
int
p7_oprofile_GetFwdEmissionArray_neon64(const P7_OPROFILE *om, P7_BG *bg, float *arr )
{
#ifdef HAVE_NEON64
  int x, q, z, k;
  union { esl_neon_128f_t v; float f[4]; } tmp; /* used to align and read simd minivectors               */
 ...
 */
int
oprofile_dump_mf_neon64(FILE *fp, const P7_OPROFILE *om)
{
#ifdef HAVE_NEON64
  int     M   = om->M;		/* length of the query                                          */
  int     nq  = P7_NVB(M);     /* segment length; total # of striped vectors needed            */
 ...
 */
int
oprofile_dump_vf_neon64(FILE *fp, const P7_OPROFILE *om)
{
#ifdef HAVE_NEON64
  int     M   = om->M;		/* length of the query                                          */
  int     nq  = P7_NVW(M);     /* segment length; total # of striped vectors needed            */
 ...
 */
int
oprofile_dump_fb_neon64(FILE *fp, const P7_OPROFILE *om, int width, int precision)
{
#ifdef HAVE_NEON64
  int     M   = om->M;		/* length of the query                                          */
  int     nq  = P7_NVF(M);     /* segment length; total # of striped vectors needed            */
 ...
 */
int
p7_oprofile_Compare_neon64(const P7_OPROFILE *om1, const P7_OPROFILE *om2, float tol, char *errmsg)
{
#ifdef HAVE_NEON64
  int Q4  = P7_NVF(om1->M);
  int Q8  = P7_NVW(om1->M);
