...
static void process_TranslatedSearchCmd(HMMD_COMMAND_SHARD *cmd, WORKER_ENV *env, QUEUE_DATA_SHARD *query);
...
static void 
process_TranslatedSearchCmd(HMMD_COMMAND_SHARD *cmd, WORKER_ENV *env, QUEUE_DATA_SHARD *query)
{
  int              i;
  int              cnt;
  int              limit;
