...
static ESL_OPTIONS options[] = {
  ...
  { "--sopen",      eslARG_REAL,  "11.0", NULL, "0<=x<100",NULL,  NULL,  PGAPS,             "gap open score",                                               3 },
  { "--sextend",    eslARG_REAL,   "1.0", NULL, "0<=x<100",NULL,  NULL,  PGAPS,             "gap extend score",                                             3 }, /* NCBI-BLAST default for BLOSUM62 */
  { "--mxfile",     eslARG_INFILE,  NULL, NULL, NULL,      NULL,  NULL,  NULL,              "substitution score matrix [default: BLOSUM62]",                3 }, /* NCBI-BLAST default for BLOSUM62 */
...
static int
serial_ploop(WORKER_PINFO *pinfo, ESL_SQFILE *dbfp)
{
  int      sstatus;
  int      dpstatus;
...
static int
serial_sloop(WORKER_PINFO *info, ESL_SQFILE *dbfp)
{
