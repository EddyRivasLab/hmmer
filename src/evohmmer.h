...
typedef struct p7_rate_s {
  ...
  // inputs
  EMRATE          *emR;         // a fixed emission rate 
...
extern P7_RATE *p7_RateCreate(const ESL_ALPHABET *abc, int M, EMRATE *emR, ESL_SCOREMATRIX *S, EVOM evomodel, float fixtime, float betainf, float tol);
extern int      p7_RateAllocate(P7_RATE *R);
...
extern int      p7_RateCalculate(const P7_HMM *hmm, const P7_BG *bg, P7_RATE *R, char *errbuf, int verbose);
extern int      p7_RateConstruct(const P7_HMM *hmm, const P7_BG *bg, HMMRATE *hmmrate, P7_RATE **ret_R, char *errbuf, int verbose);
extern int      p7_RateTransitions(const P7_HMM *hmm, P7_RATE *R, char *errbuf, int verbose);
extern int      p7_RateValidate(P7_RATE *R, char *errbuf);
extern int      p7_EvolveFromRate(FILE *statfp, P7_HMM *hmm, const P7_RATE *R, const P7_BG *bg, double time, char *errbuf, int verbose);
extern int      p7_Evolve(P7_HMM *hmm, const P7_BG *bg, double time, HMMRATE *hmmrate, char *errbuf, int verbose);
extern int      p7_RateTest(const P7_HMM *hmm, P7_RATE *R, const P7_BG *bg, char *errbuf, int verbose);
