...
static __m256i
calc_band_unrolled_1(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_1, STEP_BANDS_1, CONVERT_1, 1)
}

static __m256i
calc_band_unrolled_2(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_2, STEP_BANDS_2, CONVERT_2, 2)
}

static __m256i
calc_band_unrolled_3(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_3, STEP_BANDS_3, CONVERT_3, 3)
}

static __m256i
calc_band_unrolled_4(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_4, STEP_BANDS_4, CONVERT_4, 4)
}

static __m256i
calc_band_unrolled_5(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_5, STEP_BANDS_5, CONVERT_5, 5)
}

static __m256i
calc_band_unrolled_6(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
...
#if MAX_BANDS > 6 /* Only include needed functions to limit object file size */
static __m256i
calc_band_unrolled_7(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_7, STEP_BANDS_7, CONVERT_7, 7)
}

static __m256i
calc_band_unrolled_8(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_8, STEP_BANDS_8, CONVERT_8, 8)
}

static __m256i
calc_band_unrolled_9(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_9, STEP_BANDS_9, CONVERT_9, 9)
}

static __m256i
calc_band_unrolled_10(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_10, STEP_BANDS_10, CONVERT_10, 10)
}

static __m256i
calc_band_unrolled_11(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_11, STEP_BANDS_11, CONVERT_11, 11)
}

static __m256i
calc_band_unrolled_12(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_12, STEP_BANDS_12, CONVERT_12, 12)
}

static __m256i
calc_band_unrolled_13(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_13, STEP_BANDS_13, CONVERT_13, 13)
}

static __m256i
calc_band_unrolled_14(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
...
#if MAX_BANDS > 14
static __m256i
calc_band_unrolled_15(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_15, STEP_BANDS_15, CONVERT_15, 15)
}

static __m256i
calc_band_unrolled_16(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_16, STEP_BANDS_16, CONVERT_16, 16)
}

static __m256i
calc_band_unrolled_17(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  CALC_UNROLLED(RESET_17, STEP_BANDS_17, CONVERT_17, 17)
}

static __m256i
calc_band_unrolled_18(const ESL_DSQ *dsq, int L, const P7_OPROFILE *om, int q, __m256i beginv, register __m256i xEv)
{
  ...
  for (i = 1; i <= L; i++) 
    {
       ...
       */
      mpv =esl_avx_rightshift_int8(dp[Q-1], _mm256_setzero_si256());
