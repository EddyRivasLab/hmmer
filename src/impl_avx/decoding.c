...
// This functcion performs scalar computations on scalar values that are generated by SIMD
// vector computations.  Since the SSE and AVX versions of the vector computations generate the same 
// scalar results, there is no need for separate SSE and AVX implementations of this function.
int
