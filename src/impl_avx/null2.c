...
p7_Null2_ByExpectation_Dispatcher(const P7_OPROFILE *om, const P7_OMX *pp, float *null2)
{
  ...
  p7_Null2_ByExpectation = p7_Null2_ByExpectation_test_all;
  return p7_Null2_ByExpectation_test_all(om, pp, null2);
#endif

#ifdef P7_TEST_SSE_AVX
  p7_Null2_ByExpectation = p7_Null2_ByExpectation_test_sse_avx;
  return p7_Null2_ByExpectation_test_sse_avx(om, pp, null2);
#endif

#ifdef eslENABLE_AVX512  // Fastest first.
  if (esl_cpu_has_avx512())
    {
      p7_Null2_ByExpectation = p7_Null2_ByExpectation_avx512;
      return p7_Null2_ByExpectation_avx512(om, pp, null2);
    }
#endif
  ...
  if (esl_cpu_has_avx())
    {
      p7_Null2_ByExpectation = p7_Null2_ByExpectation_avx;
      return p7_Null2_ByExpectation_avx(om, pp, null2);
    }
#endif
  ...
  p7_Die("p7_Null2_ByExpectation_Dispatcher found no vector implementation - that shouldn't happen.");
  return eslFAIL;
}

int
(*p7_Null2_ByExpectation)(const P7_OPROFILE *om, const P7_OMX *pp, float *null2)=p7_Null2_ByExpectation_Dispatcher;
...
static int
p7_Null2_ByTrace_Dispatcher(const P7_OPROFILE *om, const P7_TRACE *tr, int zstart, int zend, P7_OMX *wrk, float *null2)
{
#ifdef P7_TEST_ALL_SIMD
  p7_Null2_ByTrace = p7_Null2_ByTrace_test_all;
  return p7_Null2_ByTrace_test_all(om, tr, zstart, zend, wrk,  null2);
#endif

#ifdef P7_TEST_SSE_AVX
  p7_Null2_ByTrace = p7_Null2_ByTrace_test_sse_avx;
  return p7_Null2_ByTrace_test_sse_avx(om, tr, zstart, zend, wrk,  null2);
#endif

#ifdef eslENABLE_AVX512  // Fastest first.
  if (esl_cpu_has_avx512())
    {
      p7_Null2_ByTrace = p7_Null2_ByTrace_avx512;
      return p7_Null2_ByTrace_avx512(om, tr, zstart, zend, wrk,  null2);
    }
#endif
  ...
  if (esl_cpu_has_avx())
    {
      p7_Null2_ByTrace = p7_Null2_ByTrace_avx;
      return p7_Null2_ByTrace_avx(om, tr, zstart, zend, wrk,  null2);
    }
#endif
  ...
  p7_Die("p7_Null2_ByTrace_Dispatcher found no vector implementation - that shouldn't happen.");
  return eslFAIL;
}

int
(*p7_Null2_ByTrace)(const P7_OPROFILE *om, const P7_TRACE *tr, int zstart, int zend, P7_OMX *wrk, float *null2) =p7_Null2_ByTrace_Dispatcher;
