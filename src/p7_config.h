 ...
 * p7_ETARGET_AMINO empirically tuned constants, from the work of Steve Johnson.
 * p7_ETARGET_DNA empirically tuned constant from Travis Wheeler (09/10/20)
 */
#define p7_ETARGET_AMINO  0.59 /* bits */
#define p7_ETARGET_DNA    0.45 /* bits */
 ...
 */
#define HMMER_VERSION "3.0b3"
#define HMMER_DATE "November 2009"
#define HMMER_COPYRIGHT "Copyright (C) 2009 Howard Hughes Medical Institute."
