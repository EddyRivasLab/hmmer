...
\prog{hmmpfam}, and \prog{hmmsearch}, there is a corresponding PVM program
(\prog{hmmcalibrate-pvm}, \prog{hmmpfam-pvm}, and
\prog{hmmsearch-pvm}). The master needs copies of all the HMMER
...
just by adding the option \prog{--pvm}; for instance,\\
...
On fisher, all HMMER executables are installed in \prog{/usr/local/bin}.  On
