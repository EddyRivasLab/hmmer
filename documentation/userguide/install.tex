...
Download \prog{hmmer-3.0rc2.tar.gz} from
\url{http://hmmer.org/}, or directly from
\url{ftp://selab.janelia.org/pub/software/hmmer3/hmmer-3.0rc2.tar.gz};
untar; and change into the newly created directory \prog{hmmer-3.0rc2}:

\user{wget ftp://selab.janelia.org/pub/software/hmmer3/hmmer-3.0rc2.tar.gz}\\
\user{tar xf hmmer-3.0rc2.tar.gz}\\
\user{cd hmmer-3.0rc2}
