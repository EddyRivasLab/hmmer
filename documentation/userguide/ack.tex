...
never released. Some versions of HMMER 1.9 escaped St. Louis and made
it to some genome centers. HMMER 1.9 burned down and sank into the
swamp in 1996.

HMMER 2 was a nearly complete rewrite, based on the new Plan 7 model
architecture, begun in November 1996. Thanks to the Washington
...
was written. Much of HMMER2 was written in coffee shops, airport
lounges, transoceanic flights, and Graeme Mitchison's kitchen. 

HMMER then settled for a while into a comfortable middle age, like its
author; actively maintained, but dramatic changes seemed
...
final release of the HMMER2 series, 2.3, was assembled in spring 2003.
The last bugfix release, 2.3.2, came out in October 2003.

For a time I thought that the combination of our 1998 book
...
program. HMMs seemed to be considered to be a mysterious black box,
rather than a natural theoretical basis for important applications
like BLAST. The NCBI seemed to be slow to adopt HMM methods. This
nagged at me. The revolution was unfinished.
...
Coincidentally, an embedded systems engineer named Michael Farrar
contacted me in January 2007. As a side hobby, Farrar had developed an
...
HMMER, and one pleasant day, I realized how to do the fast filter I
now call the SSV and MSV filters. Michael and I started corresponding
by email. We met for coffee at the Starbucks on Church Street in
Cambridge, Massachusetts in early 2008, and I started trying to
recruit him to Janelia Farm. We negotiated off and on for a year, and
he joined the group in June 2009. HMMER3.0 was first released in March
2010.
...
Shands, and Travis Wheeler.\sidenote{I write ``I'' in this guide, but
  some of it was first written by Travis.  I think there's
...
previous environment at Janelia Farm. I depend on the skills of the
teams at our high-performance computing centers. HMMER testing can
spin up hundreds or thousands of processors at a time, an unearthly
...
my earshot, that HMMER started as a re-implementation of their
...
possible. I'm a long-time user of the GNU Compile Farm and I thank all
the volunteers and donors who keep it going. I'm indebted to the free
software community for the development tools I use: an incomplete list
includes GNU gcc, gdb, emacs, and autoconf; valgrind; Subversion and
Git; Python and Perl; \LaTeX; Pandoc; and the UNIX and Linux operating
systems.

Finally, I'll close with cryptic thanks to Dave ``Mr. Frog'' Pare and
Tom ``Chainsaw'' Ruschak for an unrelated open source software product
