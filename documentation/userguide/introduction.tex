...
conserving physicochemical properties like hydrophobicity, charge, or
...
effectively, especially for insertions and deletions.
...
\paragraph{Explicit representation of alignment uncertainty.}
  ...
  probability mass this alignment has in the ensemble -- which
...
the web site, \href{http://hmmer.org}{hmmer.org}.
...
Software  &   URL \\ \hline
HH-SUITE  & \href{https://soedinglab-hh-suite.mintlify.app/}{soedinglab-hh-suite.mintlify.app}\\
