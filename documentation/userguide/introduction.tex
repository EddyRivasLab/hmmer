...
email with at most some small attachments.  \marginnote{Remember, I'm
  ...
  got other stuff to do (remember the bit about HMMER4's slow
  development?), and I'm as busy as you. I'll need to drop what I'm
  doing to try to help you out. Try to save me some time, and I'm
  more likely to stay in my usual good mood.}
...
HMMER4 has been in development since 2011.\sidenote{OK, very
  \emph{slow} development, but hey. I'm trying to teach and run a lab
  too.} Some of the stuff it will include:
