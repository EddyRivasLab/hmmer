...
\paragraph{Faster DNA search.} This beta release includes a new
...
\prog{makehmmerdb}. The tool \prog{nhmmer} 
then utilizes this binary format to support a fast new seed-finding 
stage. Using default settings in \prog{nhmmer},
we have observed a roughly 10-fold acceleration with small loss of 
...
\paragraph{} We also have some technical and usability issues we will be 
addressing Real Soon Now:
