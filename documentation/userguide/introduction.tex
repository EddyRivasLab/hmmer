...
default wordsize of 4 is $\sim$10x faster, but much less sensitive.}.
...
\item[\textbf{Speed.}] A major limitation of previous profile HMM
  ...
  implements a new heuristic acceleration algorithm. For most protein 
...
optimization curve. I still think we can accelerate the code by another 
