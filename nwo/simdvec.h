...
#define h4_2NAT_APPROX  2.8853901  // (in bits)  for SSV singlehit: NN/CC=0;   asymptotically they score -2nat
#define h4_3NAT_APPROX  4.3280851  // (in bits)  for VF multihit:   NN/CC/JJ=0,  "" -3nat
