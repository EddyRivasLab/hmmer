...
$expect = 
      q[1.8   11.7   0.0  random   3299961 3299978\s+
        4.3   10.5   0.0  random   4499980 4499997];
if ($output !~ /$expect/s) {
...
$expect = 
     q[0.91   11.7   0.0  random   3299961 3299978\s+
        2.1   10.5   0.0  random   4499980 4499997\s+
        5.3    9.3   0.0  random   1979941 1979960]; 
if ($output !~ /$expect/s) {
