/*
 * DEFAULT_ALTIVEC_SHAREDFUNCS.C
 *
 * Functions private to the default (fast, slow) and Altivec 
 * implementations of the core algorithms, as well as common
 * exported functions shared by all three implementations.
 */
 ...
 *            P7WeeViterbi().
 *            
 *            Checking the DP problem size against ViterbiSize()
 ...
 *            do a problem of MxN=12x125000, ViterbiSize() may
