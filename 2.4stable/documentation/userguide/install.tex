...
Download the source tarball (\prog{hmmer-xx.tar.gz}) from 
\htmladdnormallink{ftp://selab.janelia.org/pub/software/hmmer/CURRENT/}
                  {ftp://selab.janelia.org/pub/software/hmmer/CURRENT/}
(where \prog{xx} is the current release number, like @RELEASE@)
or from \\
\htmladdnormallink{http://hmmer.janelia.org/}
                  {http://hmmer.janelia.org/}.

Unpack the software:

\user{tar xvf hmmer-xx.tar.gz}
...
HMMER from \htmladdnormallink{http://hmmer.janelia.org/}
...
\htmladdnormallink{http://pfam.janelia.org}{http://pfam.janelia.org/}.
